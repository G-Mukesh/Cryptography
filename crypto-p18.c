...
// Permuted Choice 1 (PC1) table - 56 bits
int pc1[56] = {
    57, 49, 41, 33, 25, 17, 9,
    1, 58, 50, 42, 34, 26, 18,
    10, 2, 59, 51, 43, 35, 27,
...
// Permuted Choice 2 (PC2) table - 48 bits
int pc2[48] = {
    14, 17, 11, 24, 1, 5,
    3, 28, 15, 6, 21, 10,
    23, 19, 12, 4, 26, 8,
...
// Function to perform permutation using a table
...
// Function to display the generated subkeys
